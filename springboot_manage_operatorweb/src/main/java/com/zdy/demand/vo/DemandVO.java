...
public class DemandVO extends Page implements Serializable{
	...
	public DemandVO(DemandVO demandVO){
		if(null != demandVO){
				this.setId(demandVO.getId());
				this.setDemandName(demandVO.getDemandName());
				this.setDemandProduct(demandVO.getDemandProduct());
				this.setDemandPhase(demandVO.getDemandPhase());
				this.setDemandClient(demandVO.getDemandClient());
				this.setDemandIntroducer(demandVO.getDemandIntroducer());
				this.setDemandProposedDate(demandVO.getDemandProposedDate());
				this.setDemandExpectDate(demandVO.getDemandExpectDate());
				this.setDemandLaunchDate(demandVO.getDemandLaunchDate());
				this.setCreateUser(demandVO.getCreateUser());
				this.setCreateDate(demandVO.getCreateDate());
				this.setModifyUser(demandVO.getModifyUser());
				this.setStandby1(demandVO.getStandby1());
				this.setStandby2(demandVO.getStandby2());
				this.setStandby3(demandVO.getStandby3());
				this.setStandby4(demandVO.getStandby4());
		}
	}
	
	public DemandVO(Demand demand){
		if(null != demand){
